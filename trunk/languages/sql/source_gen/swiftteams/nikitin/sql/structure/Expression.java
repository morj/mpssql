...
public class Expression extends BaseConcept {
  public static final String concept = "swiftteams.nikitin.sql.structure.Expression";
  ...
  public static Expression newInstance(SModel sm, boolean init) {
    return (Expression)SModelUtil_new.instantiateConceptDeclaration("swiftteams.nikitin.sql.structure.Expression", sm, GlobalScope.getInstance(), init).getAdapter();
  }

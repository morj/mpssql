...
public class QueriesGenerated {
  ...
  public static boolean nodeSubstituteActionsBuilder_Precondition_AbstractOperation_1217248661054(final IOperationContext operationContext, final NodeSubstitutePreconditionContext _context) {
    System.out.println("lolsdflsdlfsdlfjalksdfjlasdjfla;sdjf;" + TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(_context.getParentNode(), "operand", true)));
        ...
        if (queryResult != null) {
          for(final SNode item : queryResult) {
            result.add(new DefaultChildNodeSubstituteAction(outputConcept, item, _context.getParentNode(), _context.getCurrentTargetNode(), _context.getChildSetter(), operationContext.getScope()) {
              ...
              public String getDescriptionText(String pattern) {
                return SPropertyOperations.getString(ref_table, "name") + "." + SPropertyOperations.getString((item), "columnName");
              }
    ...
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      if (SConceptOperations.isSuperConceptOf(childConcept, NameUtil.nodeFQName(outputConcept))) {
        Calculable calc = new Calculable() {
          ...
          public Object calculate() {
            return SLinkOperations.getTargets(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(_context.getParentNode(), "operand", true)), "parameters", true);
          }
